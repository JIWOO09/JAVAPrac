    ...
    <div id="body">
        <div class="content-container clearfix">
            ...
            <main>
                ...
                <form method="post" action="reg" enctype="multipart/form-date"">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input class="vertical-align" type="checkbox" id="open" name="open" value="true"><label for="open" class="margin-left">바로공개</label> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
